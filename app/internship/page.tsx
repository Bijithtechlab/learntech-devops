        ...
        <section className="mb-8">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg mb-8 opacity-90">
              To qualify for this transformative and highly sought-after internship program, your first step is to enroll in and successfully complete our "AI-Powered Software Development, DevOps & Cloud" course. Don't just learn; launch your career with learntechlab.
            </p>
